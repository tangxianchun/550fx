...
local FluxUI = game:GetService("CoreGui"):FindFirstChild("FluxusAndroidUI") or gethui():FindFirstChild("FluxusAndroidUI") or FluxUI
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Hosvile | commands",
	Text = "cmds: /hf to hide\n/sf to show",
	Duration = 7.5
})
